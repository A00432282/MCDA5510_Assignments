...
Please Answer:
What was it?  How did you fix?
The name 'shipppments' is miss spelt in _layout.cshtml.
...
The display name in customer model is specified as "First Name" in annotaion.it is modified as "Customer Name"
